...
@StreamBot.on_message(filters.command("creater") & filters.private)
async def creater(b,m):
    try:
...
@StreamBot.on_message(filters.command("join") & filters.private)
async def join_user(b,m):
    try:
       await b.send_message(chat_id=m.chat.id,text="HELLO",quote=True)
    except Exception:
                await b.send_message(
...
@StreamBot.on_message(filters.command("list") & filters.private)
async def list(l, m):
